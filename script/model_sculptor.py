...
class ModelSculptor:
    ...
    def __init__(self, file_name):
        ...
        self.model.set_reference_point_index(12, -1)#TODO
        self.model.set_distance_points_index([0, 6], [-1, -1])#TODO
        ...
        """
        self.feature_points_location[7].add(-0.04, 0.03, 0)#7
        self.feature_points_location[8].add(0, 0.02, 0)#8
        self.feature_points_location[9].add(0.03, 0, 0)#9
        self.feature_points_location[11].add(0, 0.03, 0)#11
        """
